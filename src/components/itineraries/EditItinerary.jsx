...
const EditItinerary = () => {
    ...
    const fetchItinerary = async () => {
      try {
        ...
        setFormData({
          ...
          tags: itinerary.tags || ["culture", "beach"],
          is_recommended: itinerary.is_recommended || false,
        })
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://pathcraft-backend.onrender.com/api/itineraries/${id}`, updatedItinerary)
    ...
    <div className="create-itinerary-container">
      ...
      <form onSubmit={handleSubmit} className="itinerary-form">
        ...
        <div className="form-actions">
          <button type="button" className="btn btn-secondary" onClick={() => navigate(`/itinerary/${id}`)}>
            Cancel
          </button>
